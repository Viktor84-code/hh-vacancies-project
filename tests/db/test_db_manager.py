...
def test_get_companies_and_vacancies_count(db_manager):
    ...
    db_manager.cur.execute("INSERT INTO companies (id, name) VALUES (1, 'Test Company')")
    db_manager.cur.execute("INSERT INTO vacancies (id, company_id, name) VALUES (101, 1, 'Test Vacancy')")
